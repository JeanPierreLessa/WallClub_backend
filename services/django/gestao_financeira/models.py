...
# DEPRECATED: Model removido - usar base_transacoes_unificadas
# Tabela baseTransacoesGestao mantida no banco apenas para histórico
# Todos os dados foram migrados para base_transacoes_unificadas
# Se precisar consultar dados históricos, use queries SQL diretas
