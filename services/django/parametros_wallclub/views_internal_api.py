    ...
    try:
        ...
        for config in configuracoes:
            configs_list.append({
                ...
                'parametro_loja_31': str(config.parametro_loja_31) if config.parametro_loja_31 is not None else '',
                'parametro_loja_32': str(config.parametro_loja_32) if config.parametro_loja_32 is not None else '',
                'parametro_loja_33': str(config.parametro_loja_33) if config.parametro_loja_33 is not None else '',
                ...
                'parametro_uptal_7': str(config.parametro_uptal_7) if config.parametro_uptal_7 is not None else '',
