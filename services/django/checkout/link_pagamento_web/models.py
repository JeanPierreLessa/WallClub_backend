...
class CheckoutToken(models.Model):
    ...
    endereco_completo = models.TextField()  # Mantido para compatibilidade
    ...
    @classmethod
    def generate_token(cls, loja_id, item_nome, item_valor, nome_completo, cpf, celular, endereco_completo, created_by,
                      pedido_origem_loja=None, email=None, data_nascimento=None, logradouro=None, numero=None,
