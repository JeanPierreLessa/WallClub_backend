...
Versão para rodar DENTRO do container Docker
"""
import os
import sys
import django
...
# Configurar Django (para rodar dentro do container)
...
KEY_LOJA_TESTE = "11384322623341877660"
# ============================================
...
def teste_1_pre_autorizacao_e_captura():
    ...
    dados_transacao = {
        ...
        'nome_impresso': 'TESTE PRE AUTORIZACAO',
        'data_validade': '12/2025',
        'codigo_seguranca': '123',
        'descricao_pedido': 'Teste Pre-Autorizacao',
        'ip_address_comprador': '127.0.0.1',
        'cpf_comprador': '12345678900',
        'nome_comprador': 'Teste Pre Autorizacao',
        'numero_parcelas': 1,
        'tipo_compra': 'CREDIT_ONE_INSTALLMENT',
        'terminal_id': 'TESTE001',
        'transacao_pre_autorizada': True
    }
    ...
    try:
        ...
        resultado_pre = service.efetuar_transacao_cartao(
...
def teste_2_transacao_e_estorno():
    ...
    dados_transacao = {
        'valor': Decimal('5.00'),
        'numero_cartao': '5111111111111111',
        'nome_impresso': 'TESTE ESTORNO',
        'data_validade': '12/2025',
        'codigo_seguranca': '123',
        'descricao_pedido': 'Teste Estorno',
        'ip_address_comprador': '127.0.0.1',
        'cpf_comprador': '12345678900',
        'nome_comprador': 'Teste Estorno',
        'numero_parcelas': 1,
        'tipo_compra': 'CREDIT_ONE_INSTALLMENT',
    ...
    try:
        ...
        resultado_transacao = service.efetuar_transacao_cartao(
            dados_transacao=dados_transacao
        )
