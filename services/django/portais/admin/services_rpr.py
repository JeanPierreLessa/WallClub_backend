...
class RPRService:
    ...
    def obter_estrutura_colunas() -> List[Dict[str, Any]]:
        ...
        return [
            ...
            {'tipo': 'variavel', 'campo': 'var109_A', 'nome': None},  # Necessário para cálculo de totalizadores
            {'tipo': 'formula', 'campo': 'variavel_nova_13', 'nome': 'Impostos Diretos pagos (R$)', 'formula': '"Não Finalizada" if var101 == 0 else var109_A'},
            {'tipo': 'variavel', 'campo': 'var118_A', 'nome': None},  # Necessário para cálculo de totalizadores
            ...
            {'tipo': 'variavel', 'campo': 'var116_A', 'nome': None},  # Necessário para cálculo de totalizadores
