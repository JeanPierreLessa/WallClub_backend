...
class CadastroOwnService:
    ...
    def preparar_payload_cadastro(self, loja_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        payload = {
            ...
            "taxaAntecipacao": 0.02 if loja_data.get('antecipacao_automatica') == 'S' else 0,  # Mínimo 0.02% (API exige > 0.01%)
            ...
            "outrosMeiosCaptura": [{"meioCaptura": "E-commerce"}] if loja_data.get('aceita_ecommerce') else []
        }
