...
cd /var/www/WallClub_backend
git pull origin release/2.2.3
docker-compose build wallclub-portais wallclub-apis
docker-compose stop wallclub-portais wallclub-apis
docker-compose up -d wallclub-portais wallclub-apis
