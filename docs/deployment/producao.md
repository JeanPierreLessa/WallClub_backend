...
cd /var/www/WallClub_backend
git pull origin release-2.2.0
docker-compose build wallclub-celery-worker wallclub-celery-beat wallclub-pos
docker-compose stop wallclub-celery-worker wallclub-celery-beat wallclub-pos
docker-compose up -d wallclub-celery-worker wallclub-celery-beat wallclub-pos
