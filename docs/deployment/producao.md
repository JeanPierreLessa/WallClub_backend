...
cd /var/www/WallClub_backend
git pull origin release-2.2.0
docker-compose build wallclub-portais wallclub-celery-worker wallclub-celery-beat nginx
docker-compose stop wallclub-portais nginx wallclub-celery-worker wallclub-celery-beat
docker-compose up -d wallclub-portais nginx wallclub-celery-worker wallclub-celery-beat
