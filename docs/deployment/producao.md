...
cd /var/www/WallClub_backend
git pull origin release-2.2.0
docker-compose build nginx wallclub-portais wallclub-apis wallclub-pos
docker-compose stop nginx wallclub-portais wallclub-apis wallclub-pos
docker-compose up -d nginx wallclub-portais wallclub-apis wallclub-pos
