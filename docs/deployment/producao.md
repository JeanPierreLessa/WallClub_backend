...
cd /var/www/WallClub_backend
git pull origin release-2.2.1
docker-compose build wallclub-apis wallclub-portais
docker-compose stop wallclub-apis wallclub-portais
docker-compose up -d wallclub-apis wallclub-portais
