...
cd /var/www/WallClub_backend
git pull origin release-2.2.1
docker-compose build wallclub-apis wallclub-pos wallclub-portais nginx
docker-compose stop wallclub-apis wallclub-pos wallclub-portais nginx
docker-compose up -d wallclub-apis wallclub-pos wallclub-portais nginx
