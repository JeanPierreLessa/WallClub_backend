...
cd /var/www/WallClub_backend
git pull origin release-2.2.0
docker-compose build wallclub-celery-beat wallclub-celery-worker
docker-compose stop wallclub-celery-beat wallclub-celery-worker
docker-compose up -d wallclub-celery-beat wallclub-celery-worker
