...
cd /var/www/WallClub_backend
git pull origin release-2.2.0
docker-compose build wallclub-pos wallclub-apis nginx
docker-compose stop wallclub-pos wallclub-apis nginx
docker-compose up -d wallclub-pos wallclub-apis nginx
