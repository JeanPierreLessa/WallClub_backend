...
**Mudanças:** API Interna Cliente (6 endpoints), DNS unificado wcapi, APIInternaService helper
...
1. [APIs Internas - Overview](#apis-internas---overview)
2. [Cliente APIs](#cliente-apis) ⭐ NOVO 07/11/2025
3. [Conta Digital APIs](#conta-digital-apis)
4. [Checkout Recorrências APIs](#checkout-recorrências-apis)
5. [Ofertas APIs](#ofertas-apis)
6. [Parâmetros APIs](#parâmetros-apis)

### Integrações Externas
6. [AWS SES - Email Service](#aws-ses---email-service) ⭐ NOVO
7. [Pinbank](#pinbank)
8. [MaxMind minFraud](#maxmind-minfraud)
9. [Risk Engine - Autenticação Cliente](#risk-engine---autenticação-cliente)
10. [WhatsApp Business](#whatsapp-business)
11. [SMS](#sms)
12. [Firebase Cloud Messaging](#firebase-cloud-messaging)
13. [Apple Push Notifications](#apple-push-notifications)
14. [AWS Secrets Manager](#aws-secrets-manager)
...
**Autenticação:** OAuth 2.0 (`@require_oauth_internal`)  
...
**Autenticação:** OAuth 2.0 interno (`@require_oauth_internal`)  
