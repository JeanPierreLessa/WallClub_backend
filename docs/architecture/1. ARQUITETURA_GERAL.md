...
**Mudanças:** 4 containers independentes em produção, 9 containers totais, nginx gateway, Fases 1-6 concluídas
...
│  ├─ api.wallclub.com.br      → apis:8005      │
│  ├─ apipos.wallclub.com.br   → pos:8005       │
│  └─ checkout.wallclub.com.br → apis:8005      │
└────────────────────────────────────────────────┘
         │         │         │         │
    ┌────┴────┬────┴────┬────┴────┬────┴────┐
    │         │         │         │         │
