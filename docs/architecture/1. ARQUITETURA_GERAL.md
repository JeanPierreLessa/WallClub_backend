...
**Versão:** 3.1  
**Data:** 02/11/2025  
**Fontes:** Django README + Risk Engine README + Fase 6A/6B/6C (consolidação semântica)  
**Mudanças:** Monorepo unificado, wallclub_core extraído, containers desacoplados
...
- [Diretrizes técnicas](../1.%20DIRETRIZES.md)
...
### Status Atual: Preparação para Separação Física ✅

**Fase 6A + 6B Concluídas (01/11/2025):**
- ✅ CORE limpo (0 imports de apps)
- ✅ Dependências cruzadas resolvidas (26 APIs + 17 lazy imports)
- ✅ Containers logicamente desacoplados
- ⏳ Próximo: Fase 6C (Extrair CORE) + 6D (Separação física)

### 5 Containers Atuais (Monolito Modularizado)
...
### Container 1: Django (wallclub-prod-release300)

**Porta:** 8003  
**Recursos:** 3 workers, 2GB RAM, 1.5 CPU
...
### Container 3: Risk Engine (wallclub-riskengine)

**Porta:** 8004  
**Recursos:** 3 workers, 512MB RAM, 0.5 CPU

**Funcionalidades:**
- Análise risco <200ms
- 5 regras antifraude
- MaxMind (cache + fallback)
- Portal revisão
- 6 detectores Celery
