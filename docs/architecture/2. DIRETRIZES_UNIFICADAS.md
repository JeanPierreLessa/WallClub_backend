...
**Versão:** 3.1  
**Data:** 02/11/2025  
**Fontes:** Django DIRETRIZES.md + Risk Engine DIRETRIZES.md + Fase 6A/6B/6C  
**Mudanças:** Monorepo unificado, wallclub_core compartilhado
...
**Status:** Fase 6A + 6B + 6C concluídas (02/11/2025)
...
**1. APIs REST Internas (70% dos casos)**
...
- Checkout Recorrências: 8 endpoints
- Ofertas: 6 endpoints
...
### Sistema JWT Customizado (28/10/2025)

**18 cenários testados em produção**
...
### Login Simplificado Fintech (25/10/2025)

**Filosofia:** Senha sempre via SMS, revalidação recorrente
...
| # | Nome | Pontos | Lógica |
|---|------|--------|--------|
| 1 | Velocidade | +80 | >3 tx em 10min |
| 2 | Valor | +70 | >média × 3 |
| 3 | Device | +50 | Fingerprint novo |
| 4 | Horário | +40 | 00h-05h |
| 5 | IP | +90 | >5 CPFs no IP/24h |
...
### 5 Containers Orquestrados (19/10/2025)
